...
//
// Revision Date  : $Date: 2014/08/01 23:03:00 $
//
...
public:
  ...
  void registerAppLoader( N_LOA_Loader *appLoader )
  { appLoader_ = appLoader; }

  // Registration method for the TIA
  void registerTIA( N_ANP_AnalysisManager *anaInt )
  { anaInt_ = anaInt; }
...
private :
  ...
  N_LOA_Loader *        appLoader_;

  // TIA Manager
  N_ANP_AnalysisManager *     anaInt_;
};
