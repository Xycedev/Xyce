...
// Revision Date  : $Date: 2014/07/15 19:03:36 $
...
// Creation Date : 07/21/2008
//-----------------------------------------------------------------------------
void N_MPDE_DeviceInterface::registerDeviceInterface( N_DEV_DeviceInterface *devIntPtr )
{
...
// Creation Date : 07/21/2008
//-----------------------------------------------------------------------------
void N_MPDE_DeviceInterface::registerLinearSystem (N_LAS_System *tmp_system_ptr)
{
  devInterfacePtr_->registerLinearSystem(tmp_system_ptr);
}

//-----------------------------------------------------------------------------
// Function      : N_MPDE_DeviceInterface::registerAnalysisManager
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Rich Schiek
// Creation Date : 07/21/2008
//-----------------------------------------------------------------------------
void N_MPDE_DeviceInterface::registerAnalysisManager (N_ANP_AnalysisManager *tmp_anaIntPtr)
{
  devInterfacePtr_->registerAnalysisManager(tmp_anaIntPtr);
}
...
// Creation Date : 07/21/2008
//-----------------------------------------------------------------------------
void N_MPDE_DeviceInterface::registerNonlinearSolver (N_NLS_Manager *tmp_nlsMgrPtr)
{
