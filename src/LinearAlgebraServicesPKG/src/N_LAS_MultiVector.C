...
//
// Revision Date  : $Date: 2014/05/13 14:50:44 $
//
...
//-----------------------------------------------------------------------------
void N_LAS_MultiVector::writeToFile(const char *filename, bool useLIDs )
{
  int numProcs = aMultiVector_->Comm().NumProc();
...
// Creation Date : 08/29/03
//-----------------------------------------------------------------------------
void N_LAS_MultiVector::readFromFile( const char * filename )
{
}
