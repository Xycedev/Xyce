...
//
// Revision Date  : $Date: 2014/04/07 16:20:10 $
//
// Current Owner  : $Author: glhenni $
//-------------------------------------------------------------------------
...
const std::string N_LAS_IfpackPrecond::ifpackType_default_ = "Amesos";
...
// Creation Date : 09/27/07
//-----------------------------------------------------------------------------
bool N_LAS_IfpackPrecond::setDefaultOption( const std::string & option )
{
