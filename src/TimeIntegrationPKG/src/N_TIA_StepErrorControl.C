...
bool N_TIA_StepErrorControl::resetAll ()
{
  ...
  if (tiaParams_.debugLevel > 0)
  {
    ...
    Xyce::dout() <<
                           "  before initializeBreakPoints " << std::endl;
  ...
  {
    Xyce::dout() <<
                           "  after initializeBreakPoints " << std::endl;
    printBreakPoints(Xyce::dout());
    Xyce::dout() << "  currentPauseBP = " <<  currentPauseBP->value() << std::endl;
  }
#endif // Xyce_DEBUG_TIME
  ...
  {
    Xyce::dout() <<
                           "  after updatePauseTime & setBreakPoint" << std::endl;
    printBreakPoints(Xyce::dout());
    Xyce::dout() <<"  currentPauseBP = " <<  currentPauseBP->value() << std::endl;
    Xyce::dout() << Xyce::section_divider << std::endl;
  }
...
//#endif // Xyce_MPDE
  ...
  if (tiaParams_.bpEnable)
  {
    ...
    N_PDS_Comm &comm = anaManager_.getPDSComm();
...
//  if (anaManager_.getIntegrationMethod() == 7 && tiaParams_.newLte == true)
  ...
  if (testTimeIntegrationError)
  {
    ...
    anaManager_.getLoader().getInnerLoopErrorSums (anaManager_.getTIADataStore()->innerErrorInfoVec);
...
bool N_TIA_StepErrorControl::updateBreakPoints ()
{
  ...
  anaManager_.getLoader().getBreakPoints(tmpBP);
...
bool N_TIA_StepErrorControl::updateMaxTimeStep(double suggestedMaxTimeStep)
{
  ...
  {
    maxDevStep = anaManager_.getLoader().getMaxTimeStepSize();
  }
...
//-----------------------------------------------------------------------------
void N_TIA_StepErrorControl::setBreakPoint(const N_UTL_BreakPoint &theBP)
{
