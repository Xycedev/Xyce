...
void N_TIA_NoTimeIntegration::obtainCorrectorDeriv()
{
  ...
  ds.nextStoreLeadCurrQDerivPtr->putScalar(0.0);
}
...
void N_TIA_NoTimeIntegration::obtainResidual ()
{
  ...
  ds.RHSVectorPtr->linearCombo
    (1.0,*ds.RHSVectorPtr,-1.0,*ds.daeBVectorPtr);
#endif
...
//-----------------------------------------------------------------------------
// Function      : N_TIA_NoTimeIntegration::obtainSensitivityResiduals
//
// Purpose       : This function returns the residual for the steady state
//                 case.
//
...
// Creation Date : 
//-----------------------------------------------------------------------------
void N_TIA_NoTimeIntegration::obtainSensitivityResiduals ()
{
  ...
  for (int ip=0; ip<numParams;++ip)
  {
    ...
    RHSVec.linearCombo(0.0,RHSVec,+1.0,dfdpVec);
#ifdef SEPARATE_F_AND_B
