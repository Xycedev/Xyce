...
class N_TIA_WorkingIntegrationMethod
{
  public:
    ...
    void obtainSensitivityResiduals() { return integMethodPtr->obtainSensitivityResiduals(); }
    void loadFinalSensitivityDerivatives() { return integMethodPtr->loadFinalSensitivityDerivatives(); }
                  ...
                  bool skipPrintLineOutput )
    {
      return integMethodPtr->printOutputSolution(
          outputManagerAdapter, time, solnVecPtr, doNotInterpolate, outputInterpolationTimes, skipPrintLineOutput) ;
    }
                  ...
                  const bool doNotInterpolate)
    {
      return integMethodPtr->saveOutputSolution(
          outputManagerAdapter, solnVecPtr, saveTime, doNotInterpolate);
    }
