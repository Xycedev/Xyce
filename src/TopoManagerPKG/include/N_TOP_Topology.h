...
public:
  ...
  bool registerAnalysisManager(Xyce::Analysis::AnalysisManager * anaInt);
 ...
 // remove any nodes and devices that were tagged for removal during parsing
  ...
  Xyce::Analysis::AnalysisManager * getTIAManager() const { return anaIntPtr_; }
...
private:
  ...
  Xyce::Analysis::AnalysisManager * anaIntPtr_;
