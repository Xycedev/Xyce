...
//-------------------------------------------------------------------------
// Filename       : $RCSfile: N_UTL_OpBuilder.h,v $
//
// Purpose        :
//
// Special Notes  :
...
//-----------------------------------------------------------------------------
///
/// Builds an Op given the start of a ParameterList.
///
...
public:
  ...
  ///
  Operator *createOp(ParameterList::const_iterator &it) const;
...
private:
  ...
  /// @return   pointer to new operator or 0 if no operator could be created
  ///
  virtual Operator *makeOp(ParameterList::const_iterator &it) const = 0;
};
