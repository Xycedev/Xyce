...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterHomotopyPrn.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterHomotopyPrn_h
#define Xyce_N_IO_OutputterHomotopyPrn_h
...
class HomotopyPrn : public Interface
{
public:
  HomotopyPrn(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterHomotopyPrn_h
