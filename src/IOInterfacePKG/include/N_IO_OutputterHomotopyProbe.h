...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterHomotopyProbe.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterHomotopyProbe_h
#define Xyce_N_IO_OutputterHomotopyProbe_h
...
class HomotopyProbe : public Interface
{
public:
  HomotopyProbe(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterHomotopyProbe_h
