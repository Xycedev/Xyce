...
public:
  ...
  {
    deviceData_.getDevBlock().setNetlistLocation(NetlistLocation(netlistFile, lineNumber));
  }
...
private:
  ...
  ModelFoundState extractModelName( std::string& modelType, int & modelLevel, int & modelNamePosition );
