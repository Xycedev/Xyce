...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterSensitivity.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterSensitivity_h
#define Xyce_N_IO_OutputterSensitivity_h
...
#endif // Xyce_N_IO_OutputterSensitivity_h
