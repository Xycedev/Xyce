...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterMPDEPrn.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterMPDEPrn_h
#define Xyce_N_IO_OutputterMPDEPrn_h
...
class MPDEPrn : public Interface
{
public:
  MPDEPrn(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterMPDEPrn_h
