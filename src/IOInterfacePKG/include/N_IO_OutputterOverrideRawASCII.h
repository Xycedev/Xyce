...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterOverrideRawASCII.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterOverrideRawASCII_h
#define Xyce_N_IO_OutputterOverrideRawASCII_h
...
class OverrideRawAscii : public Interface
{
public:
  OverrideRawAscii(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterOverrideRawASCII_h
