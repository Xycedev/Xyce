...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterFrequencyCSV.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterFrequencyCSV_h
#define Xyce_N_IO_OutputterFrequencyCSV_h
...
{
public:
  FrequencyCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterFrequencyCSV_h
