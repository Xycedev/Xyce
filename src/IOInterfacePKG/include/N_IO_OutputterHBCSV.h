...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterHBCSV.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterHBCSV_h
#define Xyce_N_IO_OutputterHBCSV_h
...
class HBCSV : public HBInterface
{
public:
  HBCSV(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &freq_print_parameters, const PrintParameters &time_print_parameters);
...
#endif // Xyce_N_IO_OutputterHBCSV_h
