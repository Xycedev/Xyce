...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterHBPrn.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterHBPrn_h
#define Xyce_N_IO_OutputterHBPrn_h
...
class HBPrn : public HBInterface
{
public:
  HBPrn(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &freq_print_parameters, const PrintParameters &time_print_parameters);
...
#endif // Xyce_N_IO_OutputterHBPrn_h
