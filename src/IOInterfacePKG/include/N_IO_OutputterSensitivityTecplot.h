...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterSensitivityTecplot.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterSensitivityTecplot_h
#define Xyce_N_IO_OutputterSensitivityTecplot_h
...
class SensitivityTecPlot : public Interface
{
public:
  SensitivityTecPlot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
