...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputterTimeTecplot.h,v $
//
// Purpose        :
//
// Special Notes  :
...
#ifndef Xyce_N_IO_OutputterTimeTecplot_h
#define Xyce_N_IO_OutputterTimeTecplot_h
...
{
public:
  TimeTecplot(Parallel::Machine comm, OutputMgr &output_manager, const PrintParameters &print_parameters);
...
#endif // Xyce_N_IO_OutputterTimeTecplot_h
