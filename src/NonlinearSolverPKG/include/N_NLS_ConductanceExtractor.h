...
{
public:
  ConductanceExtractor ( NonLinearSolver & nls_, 
                               N_TOP_Topology & top_,
                               N_IO_CmdParse & cp);
...
private:
  ...
  struct ConductanceExtractor_OptionsReg : public N_IO_PkgOptionsReg
  {
   ConductanceExtractor_OptionsReg( ConductanceExtractor * ce )
   : CE(ce)
   {}
