...
//-----------------------------------------------------------------------------
// Function      : NLParams::setLinearOpt
...
// Creation Date : 01/24/01
//-----------------------------------------------------------------------------
inline void NLParams::setLinearOpt(bool flag)
{
  linearOptimization_ = flag;
}

//-----------------------------------------------------------------------------
// Function      : NLParams::resetLinearOpt
...
// Creation Date : 01/24/01
//-----------------------------------------------------------------------------
inline void NLParams::resetLinearOpt()
{
  linearOptimization_ = 0;
}

//-----------------------------------------------------------------------------
// Function      : NLParams::getLinearOpt
...
// Creation Date : 01/24/01
//-----------------------------------------------------------------------------
inline bool NLParams::getLinearOpt() const
{
