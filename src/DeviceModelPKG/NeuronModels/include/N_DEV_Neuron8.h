...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron8.h,v $
//
...
typedef Xyce::Device::Neuron8::Instance N_DEV_NeuronInstance8;
typedef Xyce::Device::Neuron8::Model N_DEV_NeuronModel8;
