...
//-------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron5.C,v $
//
// Purpose        :
//
// Special Notes  :
...
void Traits::loadInstanceParameters(ParametricData<Neuron5::Instance> &p)
{
}

void Traits::loadModelParameters(ParametricData<Neuron5::Model> &p)
{
  // Set up map for double precision param variables:
  p.addPar ("CMEM", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::cMem,
          &Neuron5::Model::cMemGiven,
          U_FARAD, CAT_NONE, "Membrane capacitance");

  p.addPar ("GMEM", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gMem,
          &Neuron5::Model::gMemGiven,
          U_OHMM1, CAT_NONE, "Membrane conductance");

  p.addPar ("VREST", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::vRest,
          &Neuron5::Model::vRestGiven,
          U_VOLT, CAT_NONE, "Resting potential");

  p.addPar ("EK", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::eK,
          &Neuron5::Model::eKGiven,
          U_VOLT, CAT_NONE, "Potassium resting potential");

  p.addPar ("GK", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gK,
          &Neuron5::Model::gKGiven,
          U_OHMM1, CAT_NONE, "Potassium base conductance");

  p.addPar ("ENA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::eNa,
          &Neuron5::Model::eNaGiven,
          U_VOLT, CAT_NONE, "Sodium resting potential");

  p.addPar ("GNA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gNa,
          &Neuron5::Model::gNaGiven,
          U_OHMM1, CAT_NONE, "Sodium base conductance");

  p.addPar ("EA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::eA,
          &Neuron5::Model::eAGiven,
          U_CM, CAT_NONE, "a-current rest potential");

  p.addPar ("GA",0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gA,
          &Neuron5::Model::gAGiven,
          U_NONE, CAT_NONE, "a-current base conductance");

  p.addPar ("ECA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::eCa,
          &Neuron5::Model::eCaGiven,
          U_NONE, CAT_NONE, "Calcium rest potential");

  p.addPar ("GCA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gCa,
          &Neuron5::Model::gCaGiven,
          U_OHMM1, CAT_NONE, "Calcium base conductance");

  p.addPar ("EKCA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::eKCa,
          &Neuron5::Model::eKCaGiven,
          U_OHMM1, CAT_NONE, "Potassium-calcium rest potential");

  p.addPar ("GKCA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::gKCa,
          &Neuron5::Model::gKCaGiven,
          U_OHMM1, CAT_NONE, "Potassium-calcium base conductance");

  p.addPar ("CAINIT", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::CaInit,
          &Neuron5::Model::CaInitGiven,
          U_OHMM1, CAT_NONE, "initial intra-cellular calcium concentration");

  p.addPar ("CAGAMMA", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::CaGamma,
          &Neuron5::Model::CaGammaGiven,
          U_OHMM1, CAT_NONE, "calcium current to concentration multiplier");

  p.addPar ("CATAU", 0.0, false, ParameterType::NO_DEP,
          &Neuron5::Model::CaTau,
          &Neuron5::Model::CaTauGiven,
...
std::map<int,std::string> & Instance::getIntNameMap ()
{
  ...
  if (intNameMap.empty ())
  {
    ...
    intNameMap[ li_aPro ] = spiceInternalName(getName(), "A");
    intNameMap[ li_bPro ] = spiceInternalName(getName(), "B");
    intNameMap[ li_M_Pro ] = spiceInternalName(getName(), "M_");
    intNameMap[ li_H_Pro ] = spiceInternalName(getName(), "H_");
    intNameMap[ li_cPro ] = spiceInternalName(getName(), "C");
    intNameMap[ li_CaPro ] = spiceInternalName(getName(), "Ca");
...
bool Instance::updateIntermediateVars ()
{
  ...
  // use scoping to avoid lots of similar variable names
  {
    ...
    resultFad = Neuron::kcl1EquF( v1Var, v2Var, nVar, mVar, hVar, aVar, bVar, M_Var, H_Var, cVar, gMemVar, vRestVar, gKVar, eKVar, gNaVar, eNaVar, gAVar, eAVar, gCaVar, eCaVar, gKCaVar);
    ...
    resultFad = Neuron::kcl2EquF( v1Var, v2Var, nVar, mVar, hVar, aVar, bVar, M_Var, H_Var, cVar, gMemVar, vRestVar, gKVar, eKVar, gNaVar, eNaVar, gAVar, eAVar, gCaVar, eCaVar, gKCaVar);
...

  {
    ...
    resultFad = Neuron::kcl1EquQ( v1Var, v2Var, cMemVar );
    kcl1Qvalue = resultFad.val();
    dkcl1Q_dV1 = resultFad.dx(0);
    dkcl1Q_dV2 = resultFad.dx(1);

    resultFad = Neuron::kcl2EquQ( v1Var, v2Var, cMemVar );
  ...
  // n - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::nEquF( v1Var, nVar);
...

  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::nEquQ( nVar );
  ...
  // m - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::mEquF( v1Var, mVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::mEquQ( mVar );
  ...
  // h - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::hEquF( v1Var, hVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::hEquQ( hVar );
  ...
  // a - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::aEquF( v1Var, aVar, vRestVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::aEquQ( aVar );
  ...
  // b - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::bEquF( v1Var, bVar, vRestVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::aEquQ( bVar );
  ...
  // M - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::M_EquF( v1Var, M_Var, vRestVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::aEquQ( M_Var );
  ...
  // H - equation
  {
    ...
    Sacado::Fad::SFad<double,2> resultFad = Neuron::H_EquF( v1Var, H_Var, vRestVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::H_EquQ( H_Var );
  ...
  // c - equation
  {
    ...
    Sacado::Fad::SFad<double,3> resultFad = Neuron::C_EquF( v1Var, cVar, CaVar, vRestVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::C_EquQ( cVar );
  ...
  // Ca - equation
  {
    ...
    Sacado::Fad::SFad<double,5> resultFad = Neuron::Ca_EquF( v1Var, v2Var, M_Var, H_Var, CaVar, gCaVar, eCaVar, CaGammaVar, CaTauVar );
  ...
  }
  {
    ...
    Sacado::Fad::SFad<double,1> resultFad = Neuron::Ca_EquQ( CaVar );
...
void registerDevice()
{
  Config<Traits>::addConfiguration()
    .registerDevice("neuron", 5)
    .registerModelType("neuron", 5);
}
