...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET_B3.h,v $
//
// Purpose        :
//
// Special Notes  :
...
typedef Xyce::Device::MOSFET_B3::Instance N_DEV_MOSFET_B3Instance;
typedef Xyce::Device::MOSFET_B3::Model N_DEV_MOSFET_B3Model;
typedef Xyce::Device::MOSFET_B3::Master N_DEV_MOSFET_B3Master;
