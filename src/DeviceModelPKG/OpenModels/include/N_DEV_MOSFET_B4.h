...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET_B4.h,v $
//
// Purpose        :
//
// Special Notes  :
...
private:
  ...
  double Igate_Jdxp;// used by rgateMod= 1,2, and 3
  double IgateMid;  // used by rgateMod= 3 only
  double IgateMid_Jdxp;  // used by rgateMod= 3 only
...
typedef Xyce::Device::MOSFET_B4::Instance N_DEV_MOSFET_B4Instance;
typedef Xyce::Device::MOSFET_B4::Model N_DEV_MOSFET_B4Model;
typedef Xyce::Device::MOSFET_B4::Master N_DEV_MOSFET_B4Master;
