...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET2.h,v $
//
// Purpose        : Level 2 Metal-oxide-semiconductor field effect transistor
//                  (MOSFET) classes.
//
// Special Notes  :
//
...
#ifndef Xyce_N_DEV_MOSFET2_h
#define Xyce_N_DEV_MOSFET2_h
...
{
  static const char *name() {return "MOSFET level 2";}
  static const char *deviceTypeName() {return "M level 2";}
...
private:
  ...
  ////////////////////////////////////////////////////////////////////
  // The following verbatim from Level=2, which has the same jacobian
  // structure
  ////////////////////////////////////////////////////////////////////
...
typedef Xyce::Device::MOSFET2::Instance N_DEV_MOSFET2Instance;
typedef Xyce::Device::MOSFET2::Model N_DEV_MOSFET2Model;
typedef Xyce::Device::MOSFET2::Master N_DEV_MOSFET2Master;
