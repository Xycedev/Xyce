...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET1.h,v $
//
...
// ---------------------
//
// Revision Number: $Revision: 1.141 $
//
...
typedef Xyce::Device::MOSFET1::Instance N_DEV_MOSFET1Instance;
typedef Xyce::Device::MOSFET1::Model N_DEV_MOSFET1Model;
typedef Xyce::Device::MOSFET1::Master N_DEV_MOSFET1Master;
