...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_VDMOS.h,v $
//
...
typedef Xyce::Device::VDMOS::Instance N_DEV_VDMOSInstance;
typedef Xyce::Device::VDMOS::Model N_DEV_VDMOSModel;
typedef Xyce::Device::VDMOS::Master N_DEV_VDMOSMaster;
