...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_BJT.h,v $
//
// Purpose        :
//
// Special Notes  :
...
// ---------------------
//
// Revision Number: $Revision: 1.161 $
//
...
typedef Xyce::Device::BJT::Instance N_DEV_BJTInstance;
typedef Xyce::Device::BJT::Model N_DEV_BJTModel;
typedef Xyce::Device::BJT::Master N_DEV_BJTMaster;
