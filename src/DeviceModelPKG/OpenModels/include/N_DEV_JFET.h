...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_JFET.h,v $
//
...
private:
  ...
  int li_store_vgs;
  int li_store_vgd;
  int li_store_dev_id;  // lead current for drain
  int li_store_dev_is;  // lead current for source
  int li_store_dev_ig;  // lead current for gate
...
typedef Xyce::Device::JFET::Instance N_DEV_JFETInstance;
typedef Xyce::Device::JFET::Model N_DEV_JFETModel;
typedef Xyce::Device::JFET::Master N_DEV_JFETMaster;
