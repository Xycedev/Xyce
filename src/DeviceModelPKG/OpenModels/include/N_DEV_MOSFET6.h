...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET6.h,v $
//
...
typedef Xyce::Device::MOSFET6::Instance N_DEV_MOSFET6Instance;
typedef Xyce::Device::MOSFET6::Model N_DEV_MOSFET6Model;
typedef Xyce::Device::MOSFET6::Master N_DEV_MOSFET6Master;
