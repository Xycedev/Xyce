...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_MOSFET_B3SOI.h,v $
//
// Purpose        :
//
// Special Notes  :
...
// ---------------------
//
// Revision Number: $Revision: 1.146 $
//
...
public:
  ...
  bool loadMatrix (N_LAS_Matrix & JMat);
  bool checkModel ();
...
typedef Xyce::Device::MOSFET_B3SOI::Instance N_DEV_MOSFET_B3SOIInstance;
typedef Xyce::Device::MOSFET_B3SOI::Model N_DEV_MOSFET_B3SOIModel;
typedef Xyce::Device::MOSFET_B3SOI::Master N_DEV_MOSFET_B3SOIMaster;
