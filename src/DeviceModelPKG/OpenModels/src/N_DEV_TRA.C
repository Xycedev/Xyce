...
// ---------------------
//
// Revision Number: $Revision: 1.174 $
//
...
std::map<int,std::string> & Instance::getIntNameMap ()
{
  ...
  if (intNameMap.empty ())
  {
    intNameMap[ li_Int1 ] = spiceInternalName(getName(), "int1");
    intNameMap[ li_Int2 ] = spiceInternalName(getName(), "int2");
    intNameMap[ li_Ibr1 ] = spiceInternalName(getName(), "i1");
    intNameMap[ li_Ibr2 ] = spiceInternalName(getName(), "i2");
  }
...
std::map<int,std::string> & N_DEV_TRAInstance::getStoreNameMap ()
{
  ...
  {
    storeNameMap[ li_store_dev_i1 ] = spiceStoreName(getName(), "DEV_I1");
    storeNameMap[ li_store_dev_i2 ] = spiceStoreName(getName(), "DEV_I2");
  }
