...
//
// Revision Date  : $Date: 2014/05/22 17:40:27 $
//
...
public:
  ...
  virtual bool loadDAEVectors (double * solVec, double * fVec, double * qVec, double * bVec, double * storeLeadF, double * storeLeadQ) /* override */;
...
//-----------------------------------------------------------------------------
template<class T>
bool DeviceMaster<T>::loadDAEVectors(double * solVec, double * fVec, double * qVec, double * bVec, double * storeLeadF, double * storeLeadQ)
{
  bool bsuccess = true;
  for (typename InstanceVector::const_iterator it = instanceVector_.begin(); it != instanceVector_.end(); ++it)
  {
