...
//-------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Units.C,v $
//
// Purpose        : 
//
// Special Notes  : 
...
UnitInfo unitTable[] =
{
  ...
  U_OHMMM2SM1,       U_INVALID,        "ohm/m**2/s",             "$\\mathsf{\\Omega}$ m$^{-2}$ s$^{-1}$",
  U_OHMMM3SM1,       U_INVALID,        "ohm/m**3/s",             "$\\mathsf{\\Omega}$ m$^{-3}$ s$^{-1}$",
