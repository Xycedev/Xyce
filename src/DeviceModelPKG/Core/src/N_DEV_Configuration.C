...
//
// Revision Date  : $Date: 2014/04/28 21:44:11 $
//
...
typedef std::map<std::string, EntityTypeId, LessNoCase> NameEntityTypeIdMap;
typedef std::map<NameLevelKey, EntityTypeId, NameLevelLess> NameLevelKeyEntityTypeIdMap;
