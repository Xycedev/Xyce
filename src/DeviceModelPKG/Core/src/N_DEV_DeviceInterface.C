...
// ---------------------
//
// Revision Number: $Revision: 1.171.2.1 $
//
...
//-----------------------------------------------------------------------------
// Function      : DeviceInterface::registerAnalysisManager
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter, SNL, Parallel Computational Sciences
// Creation Date : 03/05/02
//-----------------------------------------------------------------------------
bool DeviceInterface::registerAnalysisManager (N_ANP_AnalysisManager * tmp_anaIntPtr)
{
  return devMgrPtr_->registerAnalysisManager (tmp_anaIntPtr);
}
...
// Creation Date : 08/15/06
//-----------------------------------------------------------------------------
bool DeviceInterface::registerMeasureMgr(N_IO_MeasureMgr * measure_manager)
{
  return devMgrPtr_->registerMeasureMgr(measure_manager);
}
...
// Creation Date : 03/05/02
//-----------------------------------------------------------------------------
bool DeviceInterface::registerNonlinearSolver (Nonlinear::Manager * tmp_nlsMgrPtr)
{
...
void DeviceInterface::addDeviceToCount(const std::string & device_name, int num_devs)
{
  devMgrPtr_->addDeviceToCount(device_name, num_devs);
}

void DeviceInterface::addDevicesToCount(const std::map<std::string,int> & device_map)
{
  devMgrPtr_->addDevicesToCount(device_map);
}
...
//-----------------------------------------------------------------------------
// Function      : DeviceInterface::getAnalyticSensitivities
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter, SNL, Parallel Computational Sciences
...
//-----------------------------------------------------------------------------
void DeviceInterface::getAnalyticSensitivities
  (std::string & name, 
...
{
  return devMgrPtr_->getAnalyticSensitivities 
    (name, dfdpVec, dqdpVec, dbdpVec, 
     FindicesVec, QindicesVec, BindicesVec);
}

//-----------------------------------------------------------------------------
// Function      : DeviceInterface::analyticSensitivitiesAvailable 
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Eric Keiter, SNL, Parallel Computational Sciences
// Creation Date : 05/30/2014
//-----------------------------------------------------------------------------
bool DeviceInterface::analyticSensitivitiesAvailable (std::string & name)
{
  return devMgrPtr_->analyticSensitivitiesAvailable (name);
}
...
EntityTypeId DeviceInterface::getModelGroup(const std::string &model_type_name)
{
  return devMgrPtr_->getModelGroup(model_type_name);
}
...
//----------------------------------------------------------------------------
void DeviceInterface::addGlobalPar(const Util::Param & par)
{
...
//-----------------------------------------------------------------------------
void DeviceInterface::stepSuccess(Analysis::CurrentMode analysis)
{
...
// Creation Date : 03/12/06
//-----------------------------------------------------------------------------
void DeviceInterface::stepFailure(Analysis::CurrentMode analysis)
{
...
Device *DeviceInterface::getDevice(EntityTypeId model_type_id)
{
  return devMgrPtr_->getDevice(model_type_id);
}
